...
class TextToSpeechCubit extends Cubit<TextToSpeechState> {
    ...
    try {
      ...
      if (maleVoice != null) {
        ...
        await flutterTts.setPitch(
          0.8,
        ); // Slightly lower pitch helps it sound more masculine
      } else {
  ...
  // Method to speak the text in ZonesType.shamsiya because the voice form character not for word
  speakTextLam() {
    emit(TextToSpeachLoadingAgrument());
  }
}
